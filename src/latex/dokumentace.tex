...
\title{\includegraphics[scale=0.1,keepaspectratio]{pics/logo_cz.png}\\Užívateľská dokumentácia}
\author{Tím G.I.I.T.}
\date{\today}
...
\begin{document}
    ...
    \begin{figure}[!h]
        \centering
        \scalebox{0.5}{\includegraphics{pics/top.png}}
    ...
    \begin{figure}[!h]
        \centering
        \scalebox{0.5}{\includegraphics{pics/bottom.png}}
